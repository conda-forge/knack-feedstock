...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/knack-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6218&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/knack-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `knack` can be installed with:

```
conda install knack
```

It is possible to list all of the versions of `knack` available on your platform with:
